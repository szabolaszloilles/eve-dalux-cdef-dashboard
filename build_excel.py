"""Generate the CDEF Excel report from the Dalux JSON."""
import sys
...
JSON_PATH = sys.argv[1] if len(sys.argv) > 1 else "Dalux_Dashboard_TS_Meeting.json"
